...
|--------|-------------|--------|------------------|
| 11.10(a) | Validation of systems | ⚠ | **Open.** The CSV package is written and the automated OQ-A is executed (320/320 — [evidence/OQ-A_RUN.md](evidence/OQ-A_RUN.md)), but IQ, OQ-B…OQ-H and PQ are not executed. 4 of 18 High-risk URS items are fully verified. |
